...
function Welcome() {
  ...
  const handleData = (): WelcomeProps => {
    switch (activeWelcomePage) {
      case 1:
        return {
          title: "Welcome to Auto Exotics Dashboard",
          subtitle:
            "Currently this is an expiremental take on how one would manage the administrative section of Auto Exotics",
          image: AEBlue,
        };
      // case 2:
      //   return {
  ...
  return (
    <WelcomeStyles
      activeWelcomePage={activeWelcomePage}
      ...
      <div id="modal">
        ...
        <div id="modal-bottom">
          ...
          <span className="nav-buttons">
            ...
            {/* {activeWelcomePage === 2 && (
              <a
                href="https://github.com/antoniopataro/auto-exotic-dashboard"
                target="_blank"
              >
                <svg
                  width="15"
          ...
          <svg viewBox="0 0 50 10" width="70" height="10">
            <circle
              cx="5"
              cy="5"
              r="5"
              fill={activeWelcomePage === 1 ? "#3275f0" : "#d9d9d9"}
            />
            <circle
              cx="25"
              cy="5"
              r="5"
              fill={activeWelcomePage === 2 ? "#3275f0" : "#d9d9d9"}
            />
            {/* <circle
              cx="45"
              cy="5"
              r="5"
              fill={activeWelcomePage === 3 ? "#3275f0" : "#d9d9d9"}
            />
            <circle
              cx="65"
              cy="5"
              r="5"
              fill={activeWelcomePage === 4 ? "#3275f0" : "#d9d9d9"}
            /> */}
          </svg>
        </div>
      </div>
